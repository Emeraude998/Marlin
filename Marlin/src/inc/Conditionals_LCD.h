...
#if ANY(HAS_DGUS_LCD, MALYAN_LCD, TOUCH_UI_FTDI_EVE, ANYCUBIC_LCD_I3MEGA, ANYCUBIC_LCD_CHIRON, DWIN_CREALITY_TOUCHLCD)
  #define IS_EXTUI 1
 ...
 */
#if ANY(HAS_Z_SERVO_PROBE, FIX_MOUNTED_PROBE, STRAIN_GAUGE_PROBE, NOZZLE_AS_PROBE, TOUCH_MI_PROBE, Z_PROBE_ALLEN_KEY, Z_PROBE_SLED, SOLENOID_PROBE, SENSORLESS_PROBING, RACK_AND_PINION_PROBE)
